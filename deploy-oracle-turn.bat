@echo off
REM Автоматическое развертывание TURN-сервера на Oracle Cloud
REM Убедитесь, что terraform.tfvars настроен с вашими данными!

echo 🚀 Развертывание TURN-сервера на Oracle Cloud Free Tier
echo.
...
echo ✅ Terraform найден
echo.

REM Проверяем terraform.tfvars
...
echo ✅ terraform.tfvars найден
echo.

REM Переходим в папку terraform
cd terraform
...
echo    Убедитесь, что terraform.tfvars настроен правильно
echo.
...
echo    setup-remote-turn.bat %VPS_IP%
echo.
...
echo.
echo 📚 Подробная документация: ORACLE_CLOUD_SETUP.md
echo.
